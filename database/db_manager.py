# database/db_manager.py - Yangilangan versiya
# Bu fayl sizning mavjud database strukturangizga moslashtirilishi kerak!
...
class User:
    ...
    def __init__(self, telegram_id, library_id, first_name, last_name, 
                 ...
                 subscription_end_date=None, is_active=True):
        ...
        self.age = age
        self.study_place = study_place  # Yangi maydon
...
class DatabaseManager:
    ...
    def get_user_by_telegram_id(self, telegram_id: int) -> Optional[User]:
        ...
        self.cursor.execute("""
            SELECT telegram_id, library_id, first_name, last_name, phone_number,
                   birth_year, study_place, subscription_plan, subscription_end_date, is_active
    ...
    def update_subscription(self, library_id: str, plan_name: str) -> bool:
        ...
        try:
            if plan_name == 'Free':
                ...
                self.cursor.execute("""
                    UPDATE users 
                    SET subscription_plan = ?, subscription_end_date = NULL
                    WHERE library_id = ?
                ...
                self.cursor.execute("""
                    UPDATE users 
                    SET subscription_plan = ?, subscription_end_date = ?
                    WHERE library_id = ?
